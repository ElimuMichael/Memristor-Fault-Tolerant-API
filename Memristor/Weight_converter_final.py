...
def xbr_visualization(layer, defects, perc_def, seed_val, fix_used, or_xbar_cols, or_xbar_rows, cond_vals, mod_pos, mod_neg, mode):
...
#     plt.scatter(faulty_ones[:,1],faulty_ones[:,0], c='red', marker='o')
    ...
    plt.savefig('./visualization/layer_'+str(layer)+'_'+str(perc_def)+'_'+str(seed_val)+'_'+fix_used+'_fault_distribution.png', bbox_inches='tight', pad_inches=0.3)
...
#         w_b_C_T = np.hstack((weights, biases))
        ...
        elif fix_used == 'redundant_columns':            
        ...
        # Fault Handled Weights Using Both Existing Cells and Redundant Rows and Columns
            ...
            p_cells = grouped_cells['positive']
            n_cells = grouped_cells['negative']
        ...
        xbr_visualization(Layer, defected_weight, perc_def, seed_val, fix_used, w_dim, w_inp, cond_vals, p_cells, n_cells, model_used)
...
def accuracy_check(converted_weight, new_weight_filename='memristorWeights/Memristor_weights.npy'):
